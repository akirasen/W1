...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Utility_LinkToAccountById__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__Utility_LinkToAssetById__ = __webpack_require__(151);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__lib_common_MarketClasses__ = __webpack_require__(145);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var RoomParticipate = function (_React$Component) {
    _inherits(RoomParticipate, _React$Component);

    function RoomParticipate(props) {
        _classCallCheck(this, RoomParticipate);

        var _this = _possibleConstructorReturn(this, (RoomParticipate.__proto__ || Object.getPrototypeOf(RoomParticipate)).call(this, props));
    ...
    _createClass(RoomParticipate, [{
        ...
        value: function componentWillMount() {
            ...
            Apis.instance().db_api().exec("get_seer_room", [this.props.params.room_id, 0, 500]).then(function (r) {
                _this2.setState({ room: r });
            });

            Apis.instance().db_api().exec("get_assets", [[this.state.room.option.accept_asset]]).then(function (objs) {
                var ret = [];
                objs.forEach(function (item, index) {
                    ret.push(item);
                });
                var symbol = ret.length > 0 ? ret[0].symbol : "";

                var precision = ret.length > 0 ? Math.pow(10, parseInt(ret[0].precision)) : 1;
                _this2.setState({ asset: symbol, precision: precision });
            });
            /*
        ...
        value: function onSubmit() {
            var obj = __WEBPACK_IMPORTED_MODULE_10_seerjs_es__["b" /* ChainStore */].getAccount(__WEBPACK_IMPORTED_MODULE_15__stores_AccountStore__["a" /* default */].getState().currentAccount);
            if (!obj) return;
            var id = obj.get("id");
            var args = {
                issuer: id,
            ...
            __WEBPACK_IMPORTED_MODULE_9__actions_SeerActions__["a" /* default */].participate(args);
        }
    }, {
        key: "handleInputChange",
        value: function handleInputChange(idx, event) {
            var target = event.target;
            var checked = target.checked;
            var value = parseInt(idx);
        ...
        value: function renderDescription() {
            ...
            var filter = room.option.filter ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "td",
                null,
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "table",
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.filter.reputation
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], { amount: room.option.filter.guaranty, asset: "1.3.0" })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.filter.volume
                            )
                        )
                    )
                )
            ...
            */
            var details = null;
            var L = null;
            var total_shares = null;

            if (this.state.room.status && this.state.room.status != "closed") {
                total_shares = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "tr",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "td",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.total_shares" })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "td",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], { amount: this.state.room.running_option.total_shares, asset: room.option.accept_asset })
                    )
                );

                var idx = 0;
                if (this.state.room.room_type == 0) {
                    L = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "tr",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                            null,
                            this.state.room.running_option.lmsr.L / this.state.precision
                        )
                    );

                    details = this.state.room.running_option.selection_description.map(function (c) {
                        var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                _this3.state.room.running_option.player_count[idx]
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                _this3.state.room.running_option.lmsr_running.items[idx] / _this3.state.precision,
                                " ",
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.part" })
                            )
                        );
                        idx++;
                        return dom;
                    ...
                    details = this.state.room.running_option.selection_description.map(function (c) {
                        var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], { amount: _this3.state.room.running_option.pvp_running.total_participate[idx], asset: room.option.accept_asset })
                            )
                        );
                        idx++;
                        return dom;
                    ...
                    L = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], { amount: this.state.room.running_option.advanced.pool, asset: room.option.accept_asset })
                        )
                    );
                    ...
                    details = this.state.room.running_option.selection_description.map(function (c) {
                        var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], { amount: _this3.state.room.running_option.advanced_running.total_participate[idx][0], asset: room.option.accept_asset })
                            )
                        );
                        idx++;
                        return dom;
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                { style: { width: "130px" } },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.house.owner" })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__Utility_LinkToAccountById__["a" /* default */], { account: room.owner })
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "tr",
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.status" })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.result_owner_percent / 100,
                                "%"
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.reward_per_oracle / 100000,
                                " SEER"
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__Utility_LinkToAssetById__["a" /* default */], { asset: room.option.accept_asset })
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "tr",
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.minimum / this.state.precision
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "tr",
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.maximum / this.state.precision
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "tr",
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                room.option.input_duration_secs / 60
                            )
                        ),
                        L,
                        total_shares,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.filter" })
                            ),
                            filter
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.selections" })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                null,
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "th",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.participators" })
                                            ),
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "th",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.amount" })
                                            )
                                        )
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        value: function render() {
            ...
            if (!this.state.room.status) {
                ...
                var idx = 0;
                options = this.state.room.running_option.selection_description.map(function (c) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        { key: idx },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "radio", name: "radio", value: idx, checked: _this4.state.checked_item == idx, onChange: _this4.handleInputChange.bind(_this4, idx) }),
                        " ",
                        c
                    );
                    idx++;
                ...
                options = this.state.room.running_option.selection_description.map(function (c) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        { key: _idx },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "radio", name: "radio", value: _idx, checked: _this4.state.checked_item == _idx, onChange: _this4.handleInputChange.bind(_this4, _idx) }),
                        " ",
                        c,
                        " (",
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.current_rate" }),
                        "  1:",
                        rate[_idx],
                        " )"
                    );
                ...
                options = this.state.room.running_option.selection_description.map(function (c) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        { key: _idx2 },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "radio", name: "radio", value: _idx2, checked: _this4.state.checked_item == _idx2, onChange: _this4.handleInputChange.bind(_this4, _idx2) }),
                        " ",
                        c,
                        "(",
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.current_rate" }),
                        " 1:",
                        _this4.state.room.running_option.advanced.awards[_idx2] / 10000,
                        ")"
                    );
                    _idx2++;
                    return dom;
            ...
            if (this.state.room.room_type == 0 && this.state.room.running_option.lmsr_running) {
                ...
                var money = parseInt(this.state.room.running_option.lmsr.L * (Math.log(orgin1) - Math.log(orgin0)));
                showMoney = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "td",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, {
                        ...
                        amount: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], {
                            amount: money || 0,
            ...
            if (this.state.room.status && this.state.room.status == "opening") participate = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "content-block", style: { display: "inline-block", width: "35%", float: "right" } },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "h3",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.participate" })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    { className: "content-block", style: { width: "50%" } },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "transfer.amount" }),
                        "(",
                        this.state.room.room_type === 0 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.part" }) : this.state.asset,
                        ")",
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.amount || 0, onChange: this.changeAmount.bind(this) }),
                        showMoney
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "button",
                        { className: "button", onClick: this.onSubmit.bind(this) },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.participate" })
                    )
                )
            );
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            "div",
                                            { className: "content-block", style: { display: "inline-block", width: "60%" } },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "h3",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.info" })
                                            ),
...
RoomParticipate.propTypes = {
    room: __WEBPACK_IMPORTED_MODULE_2__Utility_ChainTypes__["a" /* default */].ChainObject.isRequired
};
RoomParticipate.defaultProps = {
    room: "props.params.room_id"
};


/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_3__Utility_BindToChainState__["a" /* default */])(RoomParticipate));
