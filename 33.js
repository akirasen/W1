...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_react_foundation_apps_src_utils_foundation_api__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_react_foundation_apps_src_utils_foundation_api___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_react_foundation_apps_src_utils_foundation_api__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Modal_BaseModal__ = __webpack_require__(105);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var OracleInput = function (_React$Component) {
    _inherits(OracleInput, _React$Component);

    function OracleInput(props) {
        _classCallCheck(this, OracleInput);

        var _this = _possibleConstructorReturn(this, (OracleInput.__proto__ || Object.getPrototypeOf(OracleInput)).call(this, props));

        _this.onSubmit = function () {
            _this.onModalClose();
            var args = {
                issuer: _this.props.account.get("id"),
                oracle: _this.state.oracle.id,
                room: _this.state.room.id,
                input: [_this.state.input]
            };
            __WEBPACK_IMPORTED_MODULE_9__actions_SeerActions__["a" /* default */].inputOracle(args);
        };
    ...
    _createClass(OracleInput, [{
        ...
        value: function componentWillMount() {
            ...
            Apis.instance().db_api().exec("get_seer_room", [this.props.params.room_id, 0, 100]).then(function (r) {
                _this2.setState({ room: r });
            });
            Apis.instance().db_api().exec("get_oracle_by_account", [this.props.account.get("id")]).then(function (r) {
                _this2.setState({ oracle: r });
            });
        }
    }, {
        key: "onModalShow",
        value: function onModalShow() {
            __WEBPACK_IMPORTED_MODULE_10_react_foundation_apps_src_utils_foundation_api___default.a.publish('oracleInputModal', "open");
        }
    }, {
        key: "onModalClose",
        value: function onModalClose() {
            __WEBPACK_IMPORTED_MODULE_10_react_foundation_apps_src_utils_foundation_api___default.a.publish('oracleInputModal', "close");
            __WEBPACK_IMPORTED_MODULE_10_react_foundation_apps_src_utils_foundation_api___default.a.unsubscribe("transaction_confirm_actions");
        }
    }, {
        key: "handleInputChange",
        value: function handleInputChange(idx) {
        ...
        value: function render() {
            ...
            if (this.state.room.running_option) {
                ...
                options = this.state.room.running_option.selection_description.map(function (c) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "label",
                        { key: idx },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "radio", name: "radio", value: idx, checked: _this3.state.input == idx, onChange: _this3.handleInputChange.bind(_this3, idx) }),
                        " ",
                        c
                    );
            ...
            options.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "label",
                { key: 255 },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "radio", name: "radio", value: 255, checked: this.state.input == 255, onChange: this.handleInputChange.bind(this, 255) }),
                " ",
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.abandon" })
            ));
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                { className: "grid-block vertical full-width-content" },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    __WEBPACK_IMPORTED_MODULE_11__Modal_BaseModal__["a" /* default */],
                    {
                        id: "oracleInputModal",
                        overlay: true,
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        { style: { margin: '12px' } },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.confirm" }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "span",
                            { style: { textTransform: 'uppercase' } },
                            "\xA0",
                            this.state.input === 255 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.abandon" }) : this.state.room.running_option ? this.state.room.running_option.selection_description[this.state.input] : null,
                            "\xA0"
                        ),
                        "?"
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button", type: "submit", value: "Submit", onClick: this.onSubmit },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "span", content: "transfer.confirm" })
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button", type: "submit", value: "Submit", onClick: this.onModalClose },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "span", content: "transfer.cancel" })
                        )
                    )
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "h3",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.oracle.input" })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { style: this.state.oracle ? {} : { width: '100%', height: '100%', position: 'absolute' } }),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            {
                                className: "button",
...
OracleInput.propTypes = {
    account: __WEBPACK_IMPORTED_MODULE_2__Utility_ChainTypes__["a" /* default */].ChainAccount
};
OracleInput.defaultProps = {
    // room: "props.params.room_id"
};


/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_3__Utility_BindToChainState__["a" /* default */])(OracleInput));
