...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Modal_OpenRoomModal__ = __webpack_require__(1657);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Modal_StopParticipateModal__ = __webpack_require__(1658);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Modal_ReserveAssetModal__ = __webpack_require__(1589);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_alt_react__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_alt_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16_alt_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_common_asset_utils__ = __webpack_require__(285);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__Utility_ChainTypes__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__Utility_BindToChainState__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__Utility_Tabs__ = __webpack_require__(1541);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__actions_SeerActions__ = __webpack_require__(1547);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__stores_AccountStore__ = __webpack_require__(49);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var AccountHouse = function (_React$Component) {
    ...
    _createClass(AccountHouse, [{
        ...
        value: function openRoom(room) {
            ...
            __WEBPACK_IMPORTED_MODULE_8_react_foundation_apps_src_utils_foundation_api___default.a.publish("open_room", "open");
        }
    }, {
        key: "stopParticipate",
        value: function stopParticipate(room) {
            this.setState({ current_room: room });
            __WEBPACK_IMPORTED_MODULE_8_react_foundation_apps_src_utils_foundation_api___default.a.publish("stop_participate", "open");
            // var args = {
            //     issuer: this.props.account.get("id"),
            //     room: room.id,
            //     input_duration_secs: 0
        ...
        value: function finalRoom(room) {
            ...
            __WEBPACK_IMPORTED_MODULE_22__actions_SeerActions__["a" /* default */].finalRoom(args);
        }
    }, {
        key: "settleRoom",
        value: function settleRoom(room) {
            ...
            __WEBPACK_IMPORTED_MODULE_22__actions_SeerActions__["a" /* default */].settleRoom(args);
        }
    }, {
        key: "todo",
        value: function todo() {}
        ...
        value: function render() {
            ...
            var myRooms = this.state.rooms.map(function (room) {
                console.log(room);
                var isMyRoom = account && __WEBPACK_IMPORTED_MODULE_23__stores_AccountStore__["a" /* default */].isMyAccount(account) && room.owner == account.get("id");
                ...
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "td",
                        null,
                        isMyRoom && room.status == "closed" ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button tiny", onClick: _this4.openRoom.bind(_this4, room) },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.open" })
                        ) : null,
                        isMyRoom && room.status == "opening" && new Date(room.option.stop).getTime() > localUTCTime ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button tiny", onClick: _this4.stopParticipate.bind(_this4, room) },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.stop_participate" })
                        ) : null,
                        (room.status == "opening" || room.status == "inputing") && (new Date(room.option.stop).getTime() < localUTCTime && new Date(room.option.stop).getTime() + room.option.input_duration_secs * 1000 > localUTCTime || new Date(room.option.stop).getTime() + room.option.input_duration_secs * 1000 < localUTCTime && new Date(room.option.stop).getTime() + room.option.input_duration_secs * 1000 + 7 * 24 * 3600000 > localUTCTime && room.owner_result.length == 0 && room.committee_result.length == 0 && room.oracle_sets.length == 0) ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "span",
                            null,
                            isMyRoom ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                                { to: "/account/" + __WEBPACK_IMPORTED_MODULE_23__stores_AccountStore__["a" /* default */].getState().currentAccount + "/rooms/" + room.id + "/input" },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "button",
                                    { className: "button tiny" },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.input" })
                                )
                            ) : null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                                { to: "/account/" + __WEBPACK_IMPORTED_MODULE_23__stores_AccountStore__["a" /* default */].getState().currentAccount + "/rooms/" + room.id + "/oracle-input" },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "button",
                                    { className: "button tiny" },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.oracle.input" })
                                )
                            )
                        ) : null,
                        isMyRoom && (room.status == "opening" || room.status == "inputing") && new Date(room.option.stop).getTime() + room.option.input_duration_secs * 1000 < localUTCTime && (room.owner_result.length != 0 || room.committee_result.length != 0 || room.oracle_sets.length != 0) ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button tiny", onClick: _this4.finalRoom.bind(_this4, room) },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.final" })
                        ) : null,
                        isMyRoom && (room.status == "finaling" || room.status == "settling") ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button tiny", onClick: _this4.settleRoom.bind(_this4, room) },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.settle" })
                        ) : null,
                        isMyRoom && (room.status == "closed" || room.room_type == 2) ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                            { to: "/account/" + _this4.props.account.get("name") + "/rooms/" + room.id + "/update" },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "button",
                                { className: "button tiny" },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.update" })
                            )
                        ) : null
                    )
                );
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            __WEBPACK_IMPORTED_MODULE_21__Utility_Tabs__["b" /* Tabs */],
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                __WEBPACK_IMPORTED_MODULE_21__Utility_Tabs__["a" /* Tab */],
                                { title: "seer.house.my" },
                                this.state.house && this.state.house.id ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "div",
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.oracle.description" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    ...
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                        "span",
                                                        null,
                                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.oracle.script" })
                                                    )
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.oracle.guaranty" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__Utility_FormattedAsset__["a" /* default */], { amount: this.state.house.guaranty, asset: "1.3.0" })
                                                )
                                            ),
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "tr",
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.oracle.reputation" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.oracle.volume" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "td",
                                                    null,
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                                            { to: "/account/" + account_name + "/update-house/" + this.state.house.id },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "button",
                                                { className: "button" },
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.house.update" })
                                            )
                                        )
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "h4",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.title" })
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "table",
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "th",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.room_id" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "th",
                                                    null,
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "th",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.type" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "th",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.start_stop" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "th",
                                                    null,
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.status" })
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "th",
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                                            { to: "/account/" + account_name + "/create-room/single=false" },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "button",
                                                { className: "button" },
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.create" })
                                            )
                                        )
                                    )
                                ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "p",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.house.not_created" })
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                                        { to: "/account/" + account_name + "/create-house/" },
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            "button",
                                            { className: "button" },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.house.create" })
                                        )
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        __WEBPACK_IMPORTED_MODULE_1_react_router_es__["b" /* Link */],
                                        { to: "/account/" + account_name + "/create-room/single=true" },
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            "button",
                                            { className: "button" },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_translate_component___default.a, { content: "seer.room.create" })
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Modal_OpenRoomModal__["a" /* default */], {
                                room: this.state.current_room,
                                account: this.props.account,
                                onClose: function onClose() {
                                    __WEBPACK_IMPORTED_MODULE_8_react_foundation_apps_src_utils_foundation_api___default.a.publish("open_room", "close");
                                }
                            })
                        )
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "div",
                            { className: "grid-block vertical" },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_14__Modal_StopParticipateModal__["a" /* default */], {
                                room: this.state.current_room,
                                account: this.props.account,
                                onClose: function onClose() {
                                    __WEBPACK_IMPORTED_MODULE_8_react_foundation_apps_src_utils_foundation_api___default.a.publish("open_room", "close");
...
AccountHouse.propTypes = {
    assetsList: __WEBPACK_IMPORTED_MODULE_19__Utility_ChainTypes__["a" /* default */].ChainAssetsList,
    symbol: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].string.isRequired
};


AccountHouse = Object(__WEBPACK_IMPORTED_MODULE_20__Utility_BindToChainState__["a" /* default */])(AccountHouse);

/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_16_alt_react__["connect"])(AccountHouse, {
    listenTo: function listenTo() {
        return [__WEBPACK_IMPORTED_MODULE_4_stores_AssetStore__["a" /* default */]];
    },
    getProps: function getProps(props) {
        var assets = Object(__WEBPACK_IMPORTED_MODULE_18_immutable__["Map"])(),
            assetsList = Object(__WEBPACK_IMPORTED_MODULE_18_immutable__["List"])();
