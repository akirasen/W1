...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Utility_HelpContent__ = __webpack_require__(691);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Utility_ChainTypes__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Utility_BindToChainState__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Utility_AssetSelector__ = __webpack_require__(1596);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_bignumber_js__ = __webpack_require__(1545);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_bignumber_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_bignumber_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_common_asset_utils__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Utility_Tabs__ = __webpack_require__(1541);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__Utility_AmountSelector__ = __webpack_require__(689);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_chain_asset_constants__ = __webpack_require__(706);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_chain_asset_constants___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16_chain_asset_constants__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_common_trxHelper__ = __webpack_require__(284);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var GRAPHENE_MAX_SHARE_SUPPLY = new __WEBPACK_IMPORTED_MODULE_12_bignumber_js___default.a(__WEBPACK_IMPORTED_MODULE_16_chain_asset_constants___default.a.GRAPHENE_MAX_SHARE_SUPPLY);

var AccountAssetCreate = function (_React$Component) {
    _inherits(AccountAssetCreate, _React$Component);

    function AccountAssetCreate(props) {
        _classCallCheck(this, AccountAssetCreate);

        var _this = _possibleConstructorReturn(this, (AccountAssetCreate.__proto__ || Object.getPrototypeOf(AccountAssetCreate)).call(this, props));
    ...
    _createClass(AccountAssetCreate, [{
        ...
        value: function resetState(props) {
            ...
            var precision = __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].get_asset_precision(4);
            var corePrecision = __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].get_asset_precision(props.core.get("precision"));

            var _getPermissions2 = this._getPermissions(0),
            ...
            var coreRateBaseAssetName = __WEBPACK_IMPORTED_MODULE_6_seerjs_es__["b" /* ChainStore */].getAsset("1.3.0").get("symbol");
        ...
        value: function _getPermissions(state) {
            var flagBooleans = __WEBPACK_IMPORTED_MODULE_13_common_asset_utils__["a" /* default */].getFlagBooleans(0);
            var permissionBooleans = __WEBPACK_IMPORTED_MODULE_13_common_asset_utils__["a" /* default */].getFlagBooleans("all");
        ...
        value: function _createAsset(e) {
            ...
            var flags = __WEBPACK_IMPORTED_MODULE_13_common_asset_utils__["a" /* default */].getFlags(flagBooleans);
            var permissions = __WEBPACK_IMPORTED_MODULE_13_common_asset_utils__["a" /* default */].getPermissions(permissionBooleans);
            ...
            __WEBPACK_IMPORTED_MODULE_3_actions_AssetActions__["a" /* default */].createAsset(account.get("id"), update, flags, permissions, core_exchange_rate, description).then(function (result) {
        ...
        value: function _hasChanged() {
            return !__WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].are_equal_shallow(this.state, this.resetState(this.props));
        }
    }, {
        key: "_reset",
        ...
        value: function onChangeBitAssetOpts(value, e) {
            ...
            switch (value) {
                ...
                case "maximum_force_settlement_volume":
                    bitasset_opts[value] = parseFloat(e.target.value) * __WEBPACK_IMPORTED_MODULE_16_chain_asset_constants___default.a.GRAPHENE_1_PERCENT;
                    break;
                case "minimum_feeds":
        ...
        value: function _onUpdateInput(value, e) {
            ...
            var precision = __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].get_asset_precision(this.state.update.precision);
            var target = e.target;
            ...
            switch (value) {
                ...
                case "max_market_fee":
                    if (new __WEBPACK_IMPORTED_MODULE_12_bignumber_js___default.a(inputValue).times(precision).gt(GRAPHENE_MAX_SHARE_SUPPLY)) {
                        errors.max_market_fee = "The number you tried to enter is too large";
                        return this.setState({ errors: errors });
                    }
                    target.value = __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].limitByPrecision(target.value, this.state.update.precision);
                ...
                case "symbol":
                    ...
                    __WEBPACK_IMPORTED_MODULE_6_seerjs_es__["b" /* ChainStore */].getAsset(symbol);
        ...
        value: function _validateEditFields(new_state) {
            ...
            errors.symbol = __WEBPACK_IMPORTED_MODULE_6_seerjs_es__["d" /* ChainValidation */].is_valid_symbol_error(new_state.symbol);
            var existingAsset = __WEBPACK_IMPORTED_MODULE_6_seerjs_es__["b" /* ChainStore */].getAsset(new_state.symbol);
            if (existingAsset) {
                errors.symbol = __WEBPACK_IMPORTED_MODULE_8_counterpart___default.a.translate("account.user_issued_assets.exists");
            }

            try {
                errors.max_supply = new_state.max_supply <= 0 ? __WEBPACK_IMPORTED_MODULE_8_counterpart___default.a.translate("account.user_issued_assets.max_positive") : new __WEBPACK_IMPORTED_MODULE_12_bignumber_js___default.a(new_state.max_supply).times(Math.pow(10, new_state.precision)).gt(GRAPHENE_MAX_SHARE_SUPPLY) ? __WEBPACK_IMPORTED_MODULE_8_counterpart___default.a.translate("account.user_issued_assets.too_large") : null;
            } catch (err) {
                console.log("err:", err);
                errors.max_supply = __WEBPACK_IMPORTED_MODULE_8_counterpart___default.a.translate("account.user_issued_assets.too_large");
            }
        ...
        value: function _onCoreRateChange(type, e) {
            var amount = void 0,
                asset = void 0;
            if (type === "quote") {
                amount = __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].limitByPrecision(e.target.value, this.state.update.precision);
                asset = null;
            } else {
                if (!e || !("amount" in e)) {
                    return;
                }
                amount = e.amount == "" ? "0" : __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].limitByPrecision(e.amount.toString().replace(/,/g, ""), this.props.core.get("precision"));
        ...
        value: function render() {
            ...
            if (symbolLength === 3) {
                createFee = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__Utility_FormattedAsset__["a" /* default */], { amount: Object(__WEBPACK_IMPORTED_MODULE_17_common_trxHelper__["c" /* estimateFee */])("asset_create", ["symbol3"], globalObject), asset: "1.3.0" });
            } else if (symbolLength === 4) {
                createFee = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__Utility_FormattedAsset__["a" /* default */], { amount: Object(__WEBPACK_IMPORTED_MODULE_17_common_trxHelper__["c" /* estimateFee */])("asset_create", ["symbol4"], globalObject), asset: "1.3.0" });
            } else if (symbolLength > 4) {
                createFee = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_7__Utility_FormattedAsset__["a" /* default */], { amount: Object(__WEBPACK_IMPORTED_MODULE_17_common_trxHelper__["c" /* estimateFee */])("asset_create", ["long_symbol"], globalObject), asset: "1.3.0" });
            }
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets." + key }),
                                ":"
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "checkbox", checked: isChecked }),
            ...
            for (var _key in permissionBooleans) {
                permissions.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "table",
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                { style: { border: "none", width: "80%" } },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets." + _key }),
                                ":"
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "td",
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "checkbox", checked: permissionBooleans[_key], onChange: function onChange() {} }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", null)
                                )
                            )
                        )
            ...
            var confirmButtons = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "button",
                    { className: "button", onClick: this._reset.bind(this), value: __WEBPACK_IMPORTED_MODULE_8_counterpart___default.a.translate("account.perm.reset") },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.perm.reset" })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "button",
                    { className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()("button", { disabled: !isValid }), onClick: this._createAsset.bind(this) },
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            __WEBPACK_IMPORTED_MODULE_14__Utility_Tabs__["b" /* Tabs */],
                            {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                __WEBPACK_IMPORTED_MODULE_14__Utility_Tabs__["a" /* Tab */],
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "label",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.symbol" }),
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: update.symbol, onChange: this._onUpdateInput.bind(this, "symbol") })
                                    ),
                                    errors.symbol ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "p",
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "label",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.max_supply" }),
                                        " ",
                                        update.symbol ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            "span",
                                            null,
                                            "(",
                                            update.symbol,
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: update.max_supply, onChange: this._onUpdateInput.bind(this, "max_supply") })
                                    ),
                                    errors.max_supply ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "p",
                                        { className: "grid-content has-error" },
                                        errors.max_supply
                                    ) : null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "label",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.decimals" }),
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { min: "0", max: "8", step: "1", type: "range", value: update.precision, onChange: this._onUpdateInput.bind(this, "precision") })
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "p",
                                        null,
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "div",
                                        { style: { marginBottom: 10 }, className: "txtlabel cancel" },
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.precision_warning" })
                                    ),
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "h3", content: "account.user_issued_assets.core_exchange_rate" }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "label",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            errors.quote_asset ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "p",
                                                { className: "grid-content has-error" },
                                                errors.quote_asset
                                            ) : null,
                                            errors.base_asset ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "p",
                                                { className: "grid-content has-error" },
                                                errors.base_asset
                                            ) : null,
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "div",
                                                    { className: "amount-selector", style: { width: "100%", paddingRight: "10px" } },
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "label", content: "account.user_issued_assets.quote" }),
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                        "div",
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "div",
                                                { className: "grid-block no-margin small-12 medium-6" },
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_15__Utility_AmountSelector__["a" /* default */], {
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "h5",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "exchange.price" }),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "span",
                                                    null,
                                                    ": ",
                                                    __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].format_number(__WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].get_asset_price(core_exchange_rate.quote.amount * __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].get_asset_precision(update.precision), { precision: update.precision }, core_exchange_rate.base.amount * __WEBPACK_IMPORTED_MODULE_5_common_utils__["a" /* default */].get_asset_precision(core), core), 2 + (parseInt(update.precision, 10) || 8))
                                                ),
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    "span",
                                                    null,
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "div",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.cer_warning_1", component: "label", className: "has-error" }),
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.cer_warning_2", component: "p" })
                                    ),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "p",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.approx_fee" }),
                                        ": ",
                                        createFee
                                    )
                                )
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "div",
                                    { className: "small-12 grid-content" },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "label", content: "account.user_issued_assets.description" }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "label",
                                        null,
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "label", content: "account.user_issued_assets.short" }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "label",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", {
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "label", content: "account.user_issued_assets.market" }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__Utility_AssetSelector__["a" /* default */], {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "div",
                                        { style: { maxWidth: 800 } },
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Utility_HelpContent__["a" /* default */], {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    permissionBooleans["charge_market_fee"] ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "div",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "h3", content: "account.user_issued_assets.market_fee" }),
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            "table",
                                            { className: "table" },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                ...
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                    ...
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                        "td",
                                                        { style: { border: "none", width: "80%" } },
                                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.charge_market_fee" }),
                                                        ":"
                                                    ),
                                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                        "td",
                                                        ...
                                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                            ...
                                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "checkbox", checked: flagBooleans.charge_market_fee }),
                                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("label", null)
                                                        )
                                                    )
                                                )
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            "div",
                                            { className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()({ disabled: !flagBooleans.charge_market_fee }) },
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "label",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.market_fee" }),
                                                " (%)",
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "number", value: update.market_fee_percent, onChange: this._onUpdateInput.bind(this, "market_fee_percent") })
                                            ),
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "label",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.max_market_fee" }),
                                                " (",
                                                update.symbol,
                                                ")",
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "number", value: update.max_market_fee, onChange: this._onUpdateInput.bind(this, "max_market_fee") })
                                            ),
                                            errors.max_market_fee ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "p",
                                                { className: "grid-content has-error" },
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "h3",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "account.user_issued_assets.flags" })
                                    ),
                                    flags
                                )
                            )
...
AccountAssetCreate.propTypes = {
    core: __WEBPACK_IMPORTED_MODULE_9__Utility_ChainTypes__["a" /* default */].ChainAsset.isRequired,
    globalObject: __WEBPACK_IMPORTED_MODULE_9__Utility_ChainTypes__["a" /* default */].ChainObject.isRequired
};
...
AccountAssetCreate = Object(__WEBPACK_IMPORTED_MODULE_10__Utility_BindToChainState__["a" /* default */])(AccountAssetCreate);
