...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Utility_BindToChainState__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__AccountRoomCreate__ = __webpack_require__(719);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var AccountRoomUpdateWrapper = function (_React$Component) {
    _inherits(AccountRoomUpdateWrapper, _React$Component);

    function AccountRoomUpdateWrapper() {
        _classCallCheck(this, AccountRoomUpdateWrapper);

        return _possibleConstructorReturn(this, (AccountRoomUpdateWrapper.__proto__ || Object.getPrototypeOf(AccountRoomUpdateWrapper)).apply(this, arguments));
    }

    _createClass(AccountRoomUpdateWrapper, [{
        key: "render",
        value: function render() {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_9__AccountRoomCreate__["default"], { room: this.props.room, account: this.props.account });
        }
    }]);

    return AccountRoomUpdateWrapper;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

AccountRoomUpdateWrapper.propTypes = {
    account: __WEBPACK_IMPORTED_MODULE_7__Utility_ChainTypes__["a" /* default */].ChainAccount.isRequired,
    room: __WEBPACK_IMPORTED_MODULE_7__Utility_ChainTypes__["a" /* default */].ChainObject.isRequired
};
AccountRoomUpdateWrapper.defaultProps = {
    room: "props.params.room_id"
};


/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_8__Utility_BindToChainState__["a" /* default */])(AccountRoomUpdateWrapper));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Utility_ChainTypes__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Utility_BindToChainState__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__actions_AssetActions__ = __webpack_require__(1542);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_seerjs_es__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__Utility_AmountSelector__ = __webpack_require__(689);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_stores_AssetStore__ = __webpack_require__(1553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__ = __webpack_require__(68);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var AccountRoomCreate = function (_React$Component) {
    _inherits(AccountRoomCreate, _React$Component);

    function AccountRoomCreate(props) {
        _classCallCheck(this, AccountRoomCreate);

        var _this = _possibleConstructorReturn(this, (AccountRoomCreate.__proto__ || Object.getPrototypeOf(AccountRoomCreate)).call(this, props));
        ...
        _this.state = {
            ...
            description: "",
            script: "",
            room_type: _this.props.params && _this.props.params.ok == "true" ? 1 : 0,
            selections: [],
            accept_asset: "1.3.0",
        ...
        if (props.room) {
            ...
            }, _defineProperty(_this$state, "selections", room.running_option.selection_description), _defineProperty(_this$state, "pvp_owner_percent", room.running_option.pvp_owner_percent), _defineProperty(_this$state, "owner_pay_fee_percent", room.owner_pay_fee_percent), _this$state);

            if (room.room_type == 0) {
                _this.state.L = room.running_option.lmsr.L;
            } else if (room.room_type == 2) {
                _this.state.pool = room.running_option.advanced.pool;
                _this.state.awards = room.running_option.advanced.awards.map(function (a) {
                    return a / 10000;
                });
            }
        }
    ...
    _createClass(AccountRoomCreate, [{
        key: "_updateRoomAward",
        value: function _updateRoomAward() {
            var args = {
                issuer: this.props.account.get("id"),
                room: this.props.room.get("id"),
                new_awards: this.props.room.get("room_type") == 2 ? this.state.awards.map(function (a) {
                    return parseInt(a * 10000);
                }) : null
            };

            __WEBPACK_IMPORTED_MODULE_6__actions_SeerActions__["a" /* default */].updateRoom(args);
        }
    }, {
        key: "_updatePool",
        value: function _updatePool() {
            var args = {
                issuer: this.props.account.get("id"),
                room: this.props.room.get("id"),
                amount: {
            ...
            __WEBPACK_IMPORTED_MODULE_6__actions_SeerActions__["a" /* default */].updatePool(args);
        }
    }, {
        key: "_updateRoom",
        value: function _updateRoom() {
            var args = {
                issuer: this.props.account.get("id"),
                room: this.props.room.get("id"),
            ...
            if (this.state.room_type == 0) {
                ...
                args.initial_option.advanced = {
                    ...
                    awards: this.state.awards.map(function (a) {
                        return parseInt(a * 10000);
                    })
                };
            }
            ...
            if (this.state.owner_pay_fee_percent && this.state.owner_pay_fee_percent > 0) {
                if (args.upgrade_option) args.upgrade_option.owner_pay_fee_percent = this.state.owner_pay_fee_percent;else args.upgrade_option = {
        ...
        value: function _createRoom() {
            var args = {
                issuer: this.props.account.get("id"),
                label: this.state.label.filter(function (l) {
                    return l.trim() != "";
                }),
                description: this.state.description,
                script: this.state.script,
            ...
            __WEBPACK_IMPORTED_MODULE_6__actions_SeerActions__["a" /* default */].createRoom(args);
        }
    }, {
        ...
        value: function componentWillMount() {
            ...
            __WEBPACK_IMPORTED_MODULE_5_seerjs_ws__["Apis"].instance().db_api().exec("list_assets", ["A", 100]).then(function (results) {
                _this2.setState({ assets: results });
                for (var i = 0; i < _this2.state.assets.length; i++) {
                    if (_this2.state.assets[i].id === _this2.state.accept_asset) {
                        var a = _this2.state.assets[i];
                        _this2.setState({ accept_asset_precision: Math.pow(10, parseInt(a.precision)), accept_asset_symbol: a.symbol });
                        break;
                    }
                }
            });
        ...
        key: "_changeLabel",
        value: function _changeLabel(i, e) {
        ...
        key: "_changeAwards",
        value: function _changeAwards(i, e) {
        ...
        key: "_changeScript",
        value: function _changeScript(e) {
            this.setState({ script: e.target.value });
        }
    }, {
        key: "_changeRoomType",
        value: function _changeRoomType(e) {
            this.setState({ room_type: parseInt(e.target.value) });
        }
    }, {
        key: "_changeRoomSelections",
        value: function _changeRoomSelections(i, e) {
        ...
        key: "_removeLabel",
        value: function _removeLabel(idx) {
            var labels = this.state.label;
            labels.splice(idx, 1);
            this.setState({ label: labels });
        }
        ...
        value: function _removeSelection(idx) {
            var selections = this.state.selections;
            selections.splice(idx, 1);
            this.setState({ selections: selections });
        }
    }, {
        key: "_addSelectionType2",
        value: function _addSelectionType2() {
            var selections = this.state.selections;
            selections.push("");
            this.setState({ selections: selections });
        ...
        key: "_removeSelectionType2",
        value: function _removeSelectionType2(idx) {
            var selections = this.state.selections;
            selections.splice(idx, 1);
            this.setState({ selections: selections });
        ...
        */
        ...
        value: function render() {
            ...
            var type_opts = [{ label: "PVD", value: 0 }, { label: "PVP", value: 1 }, { label: "Advanced", value: 2 }];

            var i = 0;

            var type_options = [];
            type_opts.forEach(function (opt) {
            ...
            var room_type = void 0;
            switch (this.state.room_type) {
                case 0:
                    room_type = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "label",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.L" }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.L / this.state.accept_asset_precision, onChange: function onChange(e) {
                                    return _this3.setState({ L: parseInt(e.target.value * _this3.state.accept_asset_precision) });
                                } })
                        )
                    );
                    break;
                case 1:
                    room_type = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "label",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.pvp_owner_percent" }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.pvp_owner_percent / 100, onChange: function onChange(e) {
                                    return _this3.setState({ pvp_owner_percent: parseInt(e.target.value * 100) });
                                } })
                        )
                    );
                    break;
                case 2:
                    room_type = this.props.room ? null : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "div",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "label",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.pool" }),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.pool / this.state.accept_asset_precision, onChange: function onChange(e) {
                                    return _this3.setState({ pool: parseInt(e.target.value * _this3.state.accept_asset_precision) });
                                } })
                        )
                    );
            }

            var supports = this.state.assets.map(function (a) {
                if (a.symbol == "SEER") {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "option",
                        { selected: true, key: a.id, value: a.id },
                        a.symbol
                    );
            ...
            */
            var oracles = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                null,
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "p",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.reputation" }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.reputation, onChange: function onChange(e) {
                            return _this3.setState({ reputation: e.target.value });
                        } })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "label",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.guaranty" }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.guaranty, onChange: function onChange(e) {
                            return _this3.setState({ guaranty: e.target.value });
                        } })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "label",
                    null,
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.volume" }),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.volume, onChange: function onChange(e) {
                            return _this3.setState({ volume: e.target.value });
                        } })
                )
            );

            i = 0;
            var labels = this.state.label.map(function (l) {
                var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "tr",
                    { key: i },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "td",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: l, onChange: _this3._changeLabel.bind(_this3, i) })
                    ),
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "td",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "button",
                            { className: "button outline", onClick: _this3._removeLabel.bind(_this3, i) },
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "settings.remove" })
                        )
                    )
                );
                i++;
            ...
            if (this.state.room_type == 2) {
                selections = this.state.selections.map(function (s) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "tr",
                        { key: i },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: s, onChange: _this3._changeRoomSelections.bind(_this3, i) })
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: _this3.state.awards[i], onChange: _this3._changeAwards.bind(_this3, i) })
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "button",
                                { className: "button outline", onClick: _this3._removeSelectionType2.bind(_this3, i) },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "settings.remove" })
                            )
                        )
                    );
                ...
                selections = this.state.selections.map(function (s) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "button",
                                { className: "button outline", onClick: _this3._removeSelection.bind(_this3, i) },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "settings.remove" })
                            )
                        )
                    );
            ...
            var awards_type2 = null;
            if (this.props.room && this.props.room.toJS().room_type == 2) {
                var _i = 0;
                var this_selections = this.state.selections.map(function (s) {
                    var dom = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "tr",
                        { key: _i },
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "td",
                            null,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: _this3.state.awards[_i], onChange: _this3._changeAwards.bind(_this3, _i) })
                        )
                    );
                    _i++;
                    return dom;
                ...
                awards_type2 = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    "div",
                    null,
                    this.state.selections.length ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        "table",
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "thead",
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "th",
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.selection_description" })
                                ),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "th",
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.awards" })
                                ),
            ...
            return this.props.room && this.props.room.toJS().status != "closed" && this.props.room.toJS().status != "finished" && this.props.room.toJS().room_type == 2 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "div",
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "h3",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.update" })
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "div",
                            { className: "small-12 grid-content", style: { padding: "15px" } },
                            awards_type2,
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "button",
                                { className: "button", onClick: this._updateRoomAward.bind(this) },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.update" })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "div",
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "h3",
                                        null,
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.update_pool" })
                                    )
                                ),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "div",
                                    { className: "small-12 grid-content", style: { padding: "15px" } },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.pool_explain" }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__Utility_FormattedAsset__["a" /* default */], { amount: this.state.pool, asset: this.state.accept_asset_symbol }),
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__Utility_AmountSelector__["a" /* default */], {
                                        amount: this.state.pool2modified,
                                        onChange: function onChange(v) {
                                            return _this3.setState({ pool2modified: v.amount });
                                        },
                                    ...
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "button",
                                        { className: "button", onClick: this._updatePool.bind(this) },
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.update_pool" })
                                    )
                                )
                            )
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "div",
                            { className: "tabs-header" },
                            this.props.room ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "h3",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.update" })
                            ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "h3",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.create" })
                            )
                        ),
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                            "div",
                            { className: "small-12 grid-content", style: { padding: "15px" } },
                            this.props.room ? null : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "div",
                                null,
                                this.state.label.length ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "table",
                                    { className: "" },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                        "thead",
                                        ...
                                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                            ...
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                                "th",
                                                null,
                                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.label" })
                                            ),
                                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("th", null)
                                        )
                                    ),
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "button",
                                    { className: "button small", onClick: this._addLabel.bind(this) },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, {
                                        content: "seer.room.add_label" })
                                )
                            ),
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "label",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.oracle.description" }),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.description, onChange: this._changeDescription.bind(this) })
                            ),
                            this.props.room || this.props.params && this.props.params.ok == "true" ? null : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "label",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.type" }),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "select",
                                    { value: this.state.room_type, onChange: this._changeRoomType.bind(this) },
                                    type_options
                                )
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "label",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.oracle.script" }),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.script, onChange: this._changeScript.bind(this) })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "label",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.result_owner_percent" }),
                                "(%)",
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.result_owner_percent, onChange: function onChange(e) {
                                        return _this3.setState({ result_owner_percent: e.target.value });
                                    } })
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "label",
                                null,
                                oracles,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.reward_per_oracle" }),
                                "(SEER)",
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.reward_per_oracle, onChange: function onChange(e) {
                                        return _this3.setState({ reward_per_oracle: e.target.value });
                                    } })
                            ),
                            this.props.room ? null : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "div",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.accept_asset" }),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p", null),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "select",
                                    { onChange: function onChange(e) {
                                            _this3.setState({ accept_asset: e.target.value });
                                            var a = void 0;
                                            for (var i = 0; i < _this3.state.assets.length; i++) {
                                                if (_this3.state.assets[i].id === e.target.value) {
                                                    a = _this3.state.assets[i];
                                                    break;
                                                }
                                            }
                                            _this3.setState({ accept_asset_precision: Math.pow(10, parseInt(a.precision)) });

                                            _this3.setState({ accept_asset_symbol: a.symbol });
                                        } },
                                    supports
                                )
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "label",
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.min" }),
                                    "(",
                                    this.state.room_type == 0 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.part" }) : this.state.accept_asset_symbol,
                                    ")",
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { value: this.state.min, onChange: function onChange(e) {
                                            _this3.setState({ min: e.target.value });
                                        }, type: "text" })
                                )
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "label",
                                    null,
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.max" }),
                                    "(",
                                    this.state.room_type == 0 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.part" }) : this.state.accept_asset_symbol,
                                    ")",
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { value: this.state.max, onChange: function onChange(e) {
                                            _this3.setState({ max: e.target.value });
                                        }, type: "text" })
                                )
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "label",
                                null,
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.owner_pay_fee_percent" }),
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.owner_pay_fee_percent / 100, onChange: function onChange(e) {
                                        return _this3.setState({ owner_pay_fee_percent: parseInt(e.target.value * 100) });
                                    } })
                            ),
                            this.state.room_type != 2 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "div",
                                null,
                                this.state.selections.length ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "table",
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "button",
                                    { className: "button", onClick: this._addSelection.bind(this) },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.add_selection" })
                                )
                            ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "div",
                                null,
                                ...
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                    "button",
                                    { className: "button", onClick: this._addSelectionType2.bind(this) },
                                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.add_selection" })
                                )
                            ),
                            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null),
                            ...
                            this.props.room ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "button",
                                { className: "button", onClick: this._updateRoom.bind(this) },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.update" })
                            ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                                "button",
                                { className: "button", onClick: this._createRoom.bind(this) },
                                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.room.create" })
                            )
                        )
                    )
    ...
    return AccountRoomCreate;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_8__Utility_BindToChainState__["a" /* default */])(AccountRoomCreate));
