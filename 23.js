...
// CONCATENATED MODULE: ./app/components/Explorer/Assets.jsx
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Assets_Assets = function (_React$Component) {
    ...
    _createClass(Assets, [{
        ...
        value: function shouldComponentUpdate(nextProps, nextState) {
            return !immutable_default.a.is(nextProps.assets, this.props.assets) || nextState.filterUIA !== this.state.filterUIA || !utils["a" /* default */].are_equal_shallow(nextState, this.state);
        }
    }, {
        ...
        value: function _checkAssets(assets, force) {
            ...
            if (assets.size === 0 || force) {
                AssetActions["a" /* default */].getAssetList.defer("A", 100);
                this.setState({ assetsFetched: 100 });
            } else if (assets.size >= this.state.assetsFetched) {
                AssetActions["a" /* default */].getAssetList.defer(lastAsset.symbol, 100);
        ...
        value: function linkToAccount(name_or_id) {
            ...
            return react_default.a.createElement(LinkToAccountById["a" /* default */], { account: name_or_id });
        }
    }, {
        key: "_onFilter",
        value: function _onFilter(type, e) {
            this.setState(_defineProperty({}, type, e.target.value.toUpperCase()));
            SettingsActions["a" /* default */].changeViewSetting(_defineProperty({}, type, e.target.value.toUpperCase()));
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var placeholder = counterpart_default.a.translate("markets.filter").toUpperCase();
            var coreAsset = seerjs_es["b" /* ChainStore */].getAsset("1.3.0");
...

            {
                uia = assets.filter(function (a) {
                    ...
                    var marketID = asset.symbol + "_" + (description.market ? description.market : coreAsset ? coreAsset.get("symbol") : "SEER");
                    ...
                    var current_supply = asset.dynamic ? parseInt(asset.dynamic.current_supply) : 0;
                    return react_default.a.createElement(
                        "tr",
                        { key: asset.symbol },
                        ...
                        react_default.a.createElement(
                            "td",
                            null,
                            react_default.a.createElement(FormattedAsset["a" /* default */], { amount: current_supply, asset: asset.id, hide_asset: true })
                        ),
                        react_default.a.createElement(
                            "td",
                            null,
                            react_default.a.createElement(
                                es["b" /* Link */],
                                { className: "button outline", to: "/market/" + marketID },
                                react_default.a.createElement(react_translate_component_default.a, { content: "header.exchange" })
                            )
                        )
                    );
                }).sort(function (a, b) {
                        ...
                        react_default.a.createElement(
                            ...
                            react_default.a.createElement(
                                ...
                                react_default.a.createElement(
                                    ...
                                    react_default.a.createElement("input", { style: { maxWidth: "500px" }, placeholder: placeholder, type: "text", value: this.state.filterUIA, onChange: this._onFilter.bind(this, "filterUIA") })
                                )
                            ),
                            react_default.a.createElement(
                                "div",
                                { className: "grid-block", style: { paddingBottom: 20 } },
                                react_default.a.createElement(
                                    "div",
                                    { className: "grid-content" },
                                    react_default.a.createElement(
                                        ...
                                        react_default.a.createElement(
                                            ...
                                            react_default.a.createElement(
                                                ...
                                                react_default.a.createElement(
                                                    "th",
                                                    null,
                                                    react_default.a.createElement(react_translate_component_default.a, { component: "span", content: "explorer.assets.symbol" })
                                                ),
                                                react_default.a.createElement(
                                                    "th",
                                                    null,
                                                    react_default.a.createElement(react_translate_component_default.a, { component: "span", content: "explorer.assets.issuer" })
                                                ),
                                                react_default.a.createElement(
                                                    "th",
                                                    null,
                                                    react_default.a.createElement(react_translate_component_default.a, { component: "span", content: "markets.supply" })
                                                ),
...
Assets_Assets.defaultProps = {
    assets: {}
};

Assets_Assets.propTypes = {
    assets: react["PropTypes"].object.isRequired
};

/* harmony default export */ var Explorer_Assets = (Assets_Assets);
// EXTERNAL MODULE: ./app/components/Explorer/Explorer.jsx
var Explorer = __webpack_require__(50);

// CONCATENATED MODULE: ./app/components/Explorer/AssetsContainer.jsx
var AssetsContainer__createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function AssetsContainer__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AssetsContainer__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function AssetsContainer__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var AssetsContainer_AssetsContainer = function (_React$Component) {
    AssetsContainer__inherits(AssetsContainer, _React$Component);

    function AssetsContainer() {
        AssetsContainer__classCallCheck(this, AssetsContainer);

        return AssetsContainer__possibleConstructorReturn(this, (AssetsContainer.__proto__ || Object.getPrototypeOf(AssetsContainer)).apply(this, arguments));
    }

    AssetsContainer__createClass(AssetsContainer, [{
        key: "render",
        value: function render() {
            ...
            var content = react_default.a.createElement(
                ...
                {
                    stores: [AssetStore["a" /* default */], SettingsStore["a" /* default */]],
                    inject: {
                        assets: function assets() {
                            return AssetStore["a" /* default */].getState().assets;
                        },
                        filterMPA: function filterMPA() {
                            return SettingsStore["a" /* default */].getState().viewSettings.get("filterMPA");
                        },
                        filterUIA: function filterUIA() {
                            return SettingsStore["a" /* default */].getState().viewSettings.get("filterUIA");
                        }
                    }
                },
                react_default.a.createElement(Explorer_Assets, null)
            );

            return react_default.a.createElement(Explorer["default"], { tab: "assets", content: content });
        }
    }]);
...
/* harmony default export */ var Explorer_AssetsContainer = __webpack_exports__["default"] = (AssetsContainer_AssetsContainer);
