...
var GatewayStore = __webpack_require__(295);
...
// CONCATENATED MODULE: ./app/components/Layout/MenuContent.jsx
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var MenuContent_MenuContent = function (_React$Component) {
    _inherits(MenuContent, _React$Component);

    function MenuContent(props) {
        _classCallCheck(this, MenuContent);

        var _this = _possibleConstructorReturn(this, (MenuContent.__proto__ || Object.getPrototypeOf(MenuContent)).call(this));

        var menuEntries = props.menus; //this._getMenuEntries(props);
        var activeSetting = -1;
    ...
    _createClass(MenuContent, [{
        ...
        value: function _onChangeMenu(entry) {
            var index = 0;
            for (var i = 0; i < this.state.menuEntries.length; i++) {
                ...
                if (this.state.menuEntries[i].subURL && this.state.menuEntries[i].subURL.length > 0) {
                    for (var j = 0; j < this.state.menuEntries[i].subURL.length; j++) {
        ...
        value: function render() {
            ...
            return react_default.a.createElement(
                "div",
                { className: "grid-block menu-content" },
                react_default.a.createElement(
                    "div",
                    { className: "side-menu" },
                    react_default.a.createElement(
                        "div",
                        { className: "user-info" },
                        react_default.a.createElement(AccountImage["a" /* default */], {
                    ...
                    react_default.a.createElement(
                        ...
                        menuEntries.map(function (entry, index) {
                            if (entry === "separator") {
                                return react_default.a.createElement("li", { key: index, className: "menu-separator" });
                            } else {
                                return react_default.a.createElement(
                                    "li",
                                    { className: index === activeSetting ? "active" : "", onClick: _this2._redirectToEntry.bind(_this2, entry), key: entry.name },
                                    react_default.a.createElement(
                                        "svg",
                                        { className: "icon", "aria-hidden": "true" },
                                        react_default.a.createElement("use", { xlinkHref: entry.icon })
                                    ),
                                    react_default.a.createElement(react_translate_component_default.a, { content: entry.text })
                                );
                            }
                        })
                    )
                ...
                react_default.a.createElement(
                    ...
                    react_default.a.cloneElement(this.props.children, _extends({}, this.props))
                )
            )
...
MenuContent_MenuContent.contextTypes = {
    router: react_default.a.PropTypes.object.isRequired
};
MenuContent_MenuContent.propTypes = {
    menus: react_default.a.PropTypes.array.isRequired
};


/* harmony default export */ var Layout_MenuContent = (MenuContent_MenuContent);
// CONCATENATED MODULE: ./app/components/Account/AccountPage.jsx
var AccountPage__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var AccountPage__createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function AccountPage__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function AccountPage__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function AccountPage__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var AccountPage_AccountPage = function (_React$Component) {
    AccountPage__inherits(AccountPage, _React$Component);

    function AccountPage() {
        AccountPage__classCallCheck(this, AccountPage);

        return AccountPage__possibleConstructorReturn(this, (AccountPage.__proto__ || Object.getPrototypeOf(AccountPage)).apply(this, arguments));
    }

    AccountPage__createClass(AccountPage, [{
        key: "componentDidMount",
        value: function componentDidMount() {
            if (this.props.account) {
                AccountActions["a" /* default */].setCurrentAccount.defer(this.props.account.get("name"));
            }

            // Fetch possible fee assets here to avoid async issues later (will resolve assets)
            account_utils["a" /* default */].getPossibleFees(this.props.account, "transfer");
        }
    }, {
        key: "componentWillReceiveProps",
        value: function componentWillReceiveProps(np) {
            if (np.account) {
                AccountActions["a" /* default */].setCurrentAccount.defer(np.account.get("name"));
            }
        }
    }, {
        key: "render",
        value: function render() {
            ...
            var isMyAccount = AccountStore["a" /* default */].isMyAccount(account);
            ...
            return react_default.a.createElement(
                ...
                react_default.a.createElement(
                    ...
                    react_default.a.cloneElement(react_default.a.Children.only(this.props.children), {
...
AccountPage_AccountPage.propTypes = {
    account: ChainTypes["a" /* default */].ChainAccount.isRequired
};
AccountPage_AccountPage.defaultProps = {
    account: "props.params.account_name"
};

AccountPage_AccountPage = Object(BindToChainState["a" /* default */])(AccountPage_AccountPage, { keep_updating: true, show_loader: true });

var AccountPage_AccountPageStoreWrapper = function (_React$Component2) {
    AccountPage__inherits(AccountPageStoreWrapper, _React$Component2);

    function AccountPageStoreWrapper() {
        AccountPage__classCallCheck(this, AccountPageStoreWrapper);

        return AccountPage__possibleConstructorReturn(this, (AccountPageStoreWrapper.__proto__ || Object.getPrototypeOf(AccountPageStoreWrapper)).apply(this, arguments));
    }

    AccountPage__createClass(AccountPageStoreWrapper, [{
        key: "render",
        value: function render() {
            var account_name = this.props.routeParams.account_name;

            return react_default.a.createElement(AccountPage_AccountPage, AccountPage__extends({}, this.props, { account_name: account_name }));
        }
    }]);
...
/* harmony default export */ var Account_AccountPage = (Object(lib["connect"])(AccountPage_AccountPageStoreWrapper, {
    listenTo: function listenTo() {
        return [AccountStore["a" /* default */], SettingsStore["a" /* default */], WalletUnlockStore["a" /* default */], GatewayStore["a" /* default */]];
    },
    getProps: function getProps() {
        return {
            linkedAccounts: AccountStore["a" /* default */].getState().linkedAccounts,
            searchAccounts: AccountStore["a" /* default */].getState().searchAccounts,
            settings: SettingsStore["a" /* default */].getState().settings,
            hiddenAssets: SettingsStore["a" /* default */].getState().hiddenAssets,
            wallet_locked: WalletUnlockStore["a" /* default */].getState().locked,
            viewSettings: SettingsStore["a" /* default */].getState().viewSettings,
            backedCoins: GatewayStore["a" /* default */].getState().backedCoins,
            bridgeCoins: GatewayStore["a" /* default */].getState().bridgeCoins,
            gatewayDown: GatewayStore["a" /* default */].getState().down
        };
    }
}));
// EXTERNAL MODULE: ./app/components/Dashboard/DashboardAccountsOnly.jsx + 1 modules
var DashboardAccountsOnly = __webpack_require__(716);

// EXTERNAL MODULE: ./app/components/Account/AccountAssets.jsx
var AccountAssets = __webpack_require__(717);

// EXTERNAL MODULE: ./app/components/Account/AccountGuaranty.jsx
var AccountGuaranty = __webpack_require__(718);

// CONCATENATED MODULE: ./app/components/Account/Account.jsx
var Account__extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var Account__createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
function Account__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }
...
var Account_Account = function (_React$Component) {
    Account__inherits(Account, _React$Component);

    function Account() {
        Account__classCallCheck(this, Account);

        return Account__possibleConstructorReturn(this, (Account.__proto__ || Object.getPrototypeOf(Account)).apply(this, arguments));
    }
    ...
    Account__createClass(Account, [{
        ...
        value: function render() {
            ...
            var accountName = this.props.account.get("name");

            return react_default.a.createElement(Layout_MenuContent, Account__extends({
                menus: [{
                    ...
                    subURL: ["account/" + accountName + "/create-oracle", "account/" + accountName + "/update-house"],
                    text: "account.guaranty.title",
                    icon: "#icon-wodebaozhengjin"
                }, {
                    name: "/account/" + accountName + "/" + "oracle",
                    subURL: ["account/" + accountName + "/create-oracle", "account/" + accountName + "/update-oracle"],
                    text: "seer.oracle.my",
...
Account_Account = Object(BindToChainState["a" /* default */])(Account_Account, { keep_updating: true, show_loader: true });

var Account_AccountPageStoreWrapper = function (_React$Component2) {
    Account__inherits(AccountPageStoreWrapper, _React$Component2);

    function AccountPageStoreWrapper() {
        Account__classCallCheck(this, AccountPageStoreWrapper);

        return Account__possibleConstructorReturn(this, (AccountPageStoreWrapper.__proto__ || Object.getPrototypeOf(AccountPageStoreWrapper)).apply(this, arguments));
    }

    Account__createClass(AccountPageStoreWrapper, [{
        key: "render",
        value: function render() {
            var account_name = this.props.routeParams.account_name;

            return react_default.a.createElement(Account_Account, Account__extends({}, this.props, { account_name: account_name }));
        }
    }]);
...
/* harmony default export */ var components_Account_Account = __webpack_exports__["default"] = (Object(lib["connect"])(Account_AccountPageStoreWrapper, {
    listenTo: function listenTo() {
        return [AccountStore["a" /* default */], SettingsStore["a" /* default */], WalletUnlockStore["a" /* default */], GatewayStore["a" /* default */]];
    },
    getProps: function getProps() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_translate_component__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_translate_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_translate_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_stores_AssetStore__ = __webpack_require__(1553);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Utility_FormattedAsset__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__LoadingIndicator__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_immutable__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__Utility_ChainTypes__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__Utility_BindToChainState__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__AccountHouseCreate__ = __webpack_require__(196);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var roomType = ["PVD", "PVP", "Advanced"];

var AccountHouse = function (_React$Component) {
  _inherits(AccountHouse, _React$Component);

  function AccountHouse(props) {
    _classCallCheck(this, AccountHouse);

    var _this = _possibleConstructorReturn(this, (AccountHouse.__proto__ || Object.getPrototypeOf(AccountHouse)).call(this, props));
  ...
  _createClass(AccountHouse, [{
    key: "componentWillMount",
    value: function componentWillMount() {
      var _this2 = this;

      Apis.instance().db_api().exec("get_house_by_account", [this.props.account.get("id")]).then(function (results) {
        _this2.setState({ house: results, rooms: [] });
        if (results) results.rooms.forEach(function (room) {
          Apis.instance().db_api().exec("get_seer_room", [room, 0, 10]).then(function (r) {
            _this2.state.rooms.push(r);
            _this2.forceUpdate();
          });
        });
      });
    ...
    value: function componentWillReceiveProps(np) {
      ...
      if (np.account.get("id") !== this.props.account.get("id")) {
        ...
        Apis.instance().db_api().exec("get_house_by_account", [np.account.get("id")]).then(function (results) {
          _this3.setState({ house: results });
          if (results) results.rooms.forEach(function (room) {
            Apis.instance().db_api().exec("get_seer_room", [room, 0, 10]).then(function (r) {
              _this3.state.rooms.push(r);
              _this3.forceUpdate();
            });
          });
        });
    ...
    value: function render() {
      ...
      var accountExists = true;
      if (!account) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__LoadingIndicator__["a" /* default */], { type: "circle" });
      } else if (account.notFound) {
        accountExists = false;
      }
      if (!accountExists) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "h5",
            null,
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { component: "h5", content: "account.errors.not_found", name: account_name })
          )
        );
      }
      ...
      if (!(this.state.house && this.state.house.id)) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_10__AccountHouseCreate__["default"], this.props);
      }
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "table",
            { className: "table key-value-table", style: { width: "100%" } },
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              "tbody",
              null,
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  "td",
                  null,
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.oracle.guaranty" })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  "td",
                  null,
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Utility_FormattedAsset__["a" /* default */], { amount: this.state.house.guaranty, asset: "1.3.0" })
                )
              ),
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "tr",
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  "td",
                  null,
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.oracle.reputation" })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  "td",
                  null,
                  this.state.house.reputation
                )
              ),
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "tr",
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  "td",
                  null,
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_react_translate_component___default.a, { content: "seer.oracle.volume" })
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  "td",
                  null,
                  this.state.house.volume
                )
              ),
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                "tr",
...
AccountHouse.contextTypes = {
  router: __WEBPACK_IMPORTED_MODULE_0_react___default.a.PropTypes.object.isRequired
};
AccountHouse.defaultProps = {
  symbol: "",
  name: "",
  description: "",
  max_supply: 0,
...
AccountHouse.propTypes = {
  assetsList: __WEBPACK_IMPORTED_MODULE_8__Utility_ChainTypes__["a" /* default */].ChainAssetsList,
  symbol: __WEBPACK_IMPORTED_MODULE_0_react__["PropTypes"].string.isRequired
};


AccountHouse = Object(__WEBPACK_IMPORTED_MODULE_9__Utility_BindToChainState__["a" /* default */])(AccountHouse);

/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_6_alt_react__["connect"])(AccountHouse, {
  listenTo: function listenTo() {
    return [__WEBPACK_IMPORTED_MODULE_2_stores_AssetStore__["a" /* default */]];
  },
  getProps: function getProps(props) {
    var assets = Object(__WEBPACK_IMPORTED_MODULE_7_immutable__["Map"])(),
        assetsList = Object(__WEBPACK_IMPORTED_MODULE_7_immutable__["List"])();
    if (props.account.get("assets", []).size) {
      props.account.get("assets", []).forEach(function (id) {
        assetsList = assetsList.push(id);
      });
    } else {
      assets = __WEBPACK_IMPORTED_MODULE_2_stores_AssetStore__["a" /* default */].getState().assets;
    }
    return { assets: assets, assetsList: assetsList };
  }
}));
