...
class ERC20Gateway extends React.Component {
    ...
    confirmTransfer(){
        ...
        const sendAmount = new Asset({real: amount, asset_id: this.state.asset_id, precision: this.state.precision});
    ...
    initGatewaySettings(idx){
        ...
        if(idx == 0){
            ...
            this.setState({curInx: idx,asset_id:"1.3.0",precision:5,network_fee_amount:25000000,memo:"erc20#",unit:"SEER"});
        } else if(idx == 2){
            this.setState({curInx: idx});
            //this.setState({asset_id:"1.3.0",network_fee_amount:10,network_fee_asset:"1.3.0"});
        } else if(idx == 3){
            this.setState({curInx: idx,asset_id:"1.3.0",precision:5,network_fee_amount:200000,memo:"bts#",unit:"SEER"});
        }else if(idx == 4){
            this.setState({curInx: idx});
        }else if(idx == 5){
            this.setState({curInx: idx,asset_id:"1.3.2",precision:5,network_fee_amount:500000,memo:"erc20#",unit:"PFC"});
        }else if(idx == 6){
            this.setState({curInx: idx});
        }else if(idx == 7){
            this.setState({curInx: idx,asset_id:"1.3.5",precision:2,network_fee_amount:500,memo:"omni#",unit:"USDT"});
        }
    }
    ...
    renderERC20PFCIn()
    {
        ...
        return(
            <div data-title={counterpart.translate("erc20.transfer_in_title")}>
                <div className="m-t-20 balance-whitespace">{counterpart.translate("erc20.note_pfc")}</div>
                <br/>
    ...
    renderOmniUSDTIn()
    {
        ...
        return(
            <div data-title={counterpart.translate("erc20.transfer_in_title")}>
                <div className="m-t-20 balance-whitespace">{counterpart.translate("erc20.note_usdt")}</div>
                <br/>

                <div className="balance-whitespace-small">{counterpart.translate("erc20.current_account")}</div>
                <div><input type="text" readOnly={true} className="erc-btn text-center m-t-14" value={this.props.currentAccount.get("name")}/> </div> <br/>

                <div className="balance-whitespace-small">{counterpart.translate("erc20.bind_omni")}</div>
    ...
    renderOmniUSDTOut(){
        ...
        return (
            <div data-title={counterpart.translate("erc20.transfer_out_title")}>
                <div className="m-t-20">{counterpart.translate("erc20.transfer_out_omninote")}</div>
                <br/>
                <div>{counterpart.translate("erc20.transfer_out_to")}</div><br/>
                <input type="text" placeholder={counterpart.translate("erc20.placeholder_out_omniaddress")}
                       className="input-500 m-t-14"  value={this.state.address} onChange={this.handleAddressChange.bind(this)}/><br/><br/><br/>
                <div>{counterpart.translate("erc20.transfer_out_amount")}</div><br/>
                <input type="text"
                       placeholder={counterpart.translate("erc20.placeholder_out_amount", {unit: this.state.unit})}
